...
<div class="d-flex justify-content-between align-items-center">
    ...
    <a href="{{route('admin.produit.create')}}" class="btn btn-dark">Ajouter un produit</a>
</div>
<table class="table table-striped-columns">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{route('admin.produit.edit',$produit->id)}}" class="btn btn-primary">Editer</a></td>
            <td>
